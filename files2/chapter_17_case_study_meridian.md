...
The case study assumes the perspective of a Vice President at Helios Capital Partners — a hypothetical €65 billion European alternative asset manager investing across private equity, credit, and infrastructure — evaluating a take-private opportunity referred by Deutsche Bank's Financial Sponsors Group in March 2024. The teaser identifies the target as Meridian Plasma Group, a take-private candidate following recent market dislocation, with indicative enterprise value of €14–16 billion and an expression-of-interest deadline of two weeks.

Meridian is one of the world's largest plasma therapeutics companies. The founding family had previously maintained tight control of the listed equity, and the valuation had not warranted serious underwriting attention. Following a turbulent twelve months in which the stock declined 40% from its peak, the family has indicated openness to a transaction.

The instruction from the senior decision-maker is straightforward: build the model and assess whether the math supports a transaction.
...
A typical investment committee submission on a transaction of this nature requires the following work product, delivered within approximately two weeks of initial review:
...
2. **Entry Valuation:** The maximum entry price consistent with target returns (typically a 20% gross IRR for a sponsor of Helios's size and strategy), with sensitivity analysis on entry multiple, leverage, and exit assumptions.

3. **Capital Structure:** Proposed financing structure, including the appropriate split between senior secured and unsecured debt, anticipated terms, and the impact of the Change of Control provisions in the existing capital structure on deal execution.

4. **Value Creation Plan:** Operational improvements, potential add-on acquisitions, and exit strategy, with a quantified attribution of return drivers (multiple expansion, EBITDA growth, debt paydown, etc.).

5. **Key Risks and Mitigants:** Identification of the principal downside scenarios and the contractual or operational mechanisms available to mitigate each.

The preliminary materials available for the analysis include:
...
- Equity research (three analysts)

The investment committee meeting follows in two weeks.
