...
Before considering the mechanics, it is worth establishing what the covenant is designed to protect.

The "credit box" is the ring-fenced group of entities that secure the lenders' debt. A loan to a leveraged borrower is, in substance, a loan to a corporate structure — a parent company, its subsidiaries, their assets, and their cash flows. The credit box is intended to keep all of that value inside the perimeter, available to service and repay the lenders' debt.
